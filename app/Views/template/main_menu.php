<nav class="navbar-default navbar-static-side" role="navigation" id="backgroud-sidebar-own">
    <div class="sidebar-collapse">
        <ul class="nav" id="side-menu">
            <li class="nav-header">
                <div class="dropdown profile-element"> 
					<span>
                    	<img alt="image" style="width:100%; margin-left:-3px;" id='logo_menu' class="logo" src="<?php echo base_url("")."/assets/img/logo-minsal-carrusel.png"; ?>" style="width:120%; margin-left:-12%;">
                    </span>
                </div>
    ...
    <div class="row border-bottom">
        <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
        	...
        	<ul class="nav navbar-top-links navbar-left">
        		<li>
        			<br>
                    <span class="m-r-sm text-muted welcome-message"><b>PROMOCIONES</b></span>
                </li>
        	</ul>
