    ...
    <div class="col-lg-12" style="margin-top: 1%;">
        <div class="panel panel-default">
            <div class="panel-heading text-center">
                <h3 class='text-primary'><i class="fa fa-user"></i> Registro de Aviso</h3> (Los campos marcados con <span style="color:red;">*</span> son requeridos)
            </div>
                            ...
                            <div class="row">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-9">
                                        <label for="formGroupExampleInput">Seleccione la foto del aviso</label>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-sm-12 col-md-12 col-xl-12 col-12">
                                    <div class="form-group has-info single-line rounded-top" >
                                        ...
                                        <input type="text" class="form-control" name="nombre" id="nombre" onkeyup="mayus(this)" placeholder="Ingrese el Nombre del Aviso">
                                    </div>
                                </div>
                                <div class="col-lg-12 col-sm-12 col-md-12 col-xl-12 col-12">
                                    <div class="form-group has-info single-line rounded-top" >
                                        ...
                                        <select class="form-control select" name="id_tipo_aviso" id="id_tipo_aviso" style="width:100%;">
                                            ...
                                            <?php
                                                foreach ($array_tipo_avisos as $key => $value) {
                                                    echo "<option value='".$value["id_tipo_aviso"]."'>".$value["nombre"]."</option>";
                                                }
                                            ?>
                                        </select>
                                    </div>
