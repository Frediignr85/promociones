                ...
                <form id="formulario" autocomplete="off">
                    <div class="row">
                        <div class="col-lg-6 col-sm-6 col-md-6 col-xl-6 col-6">
                            <div class="form-group has-info single-line rounded-top" >
								...
								<input type="text" class="form-control" name="nombre" id="nombre" onkeyup="mayus(this)" placeholder="Ingrese el Nombre Corto del Usuario" value="<?php echo $array_usuario[0]['nombre']; ?>">
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6 col-md-6 col-xl-6 col-6">
                            <div class="form-group has-info single-line rounded-top" >
                                <label class="control-label"><span style="color:red;">* </span> Correo: </label>
								<input type="text" class="form-control" name="correo" id="correo" placeholder="Ingrese el Correo del Usuario" value="<?php echo $array_usuario[0]['correo']; ?>">
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xl-4 col-4">
                            <div class="form-group has-info single-line rounded-top" >
                                <label class="control-label"><span style="color:red;">* </span> Username: </label>
								<input type="text" class="form-control" name="username" id="username" placeholder="Ingrese el Username del Usuario" value="<?php echo $array_usuario[0]['usuario']; ?>">
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xl-4 col-4">
                            <div class="form-group has-info single-line rounded-top" >
                                <label class="control-label"><span style="color:red;">* </span> Password: </label>
								<input type="password" class="form-control" name="password" id="password" placeholder="Ingrese el Password del Usuario" value="<?php echo $array_usuario[0]['password_no_encrypt']; ?>">
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xl-4 col-4">
                            <div class="form-group has-info single-line rounded-top" >
                                <label class="control-label"><span style="color:red;">* </span> Repetir Password: </label>
								<input type="password" class="form-control" name="repetir_password" id="repetir_password" placeholder="Repita el Password" value="<?php echo $array_usuario[0]['password_no_encrypt']; ?>">
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6 col-md-6 col-xl-6 col-6">
                            <div class="form-group has-info single-line rounded-top" >
                                <label class="control-label"><span style="color:red;">* </span> Tipo de Usuario: </label>
                                <select class="form-control select" name="id_tipo_usuario" id="id_tipo_usuario" style="width:100%;" disabled>
                        ...
                        <div class="col-lg-6 col-sm-6 col-md-6 col-xl-6 col-6">
                            <div class="form-group has-info single-line rounded-top" >
                                ...
                                ?>
                                    <div class='checkbox i-checks'><label> <input id='myCheckboxes1' name='myCheckboxes1' type='checkbox' checked> <i></i>Administrador</label></div>
                                <?php
                                    }
                                    else{
                                ?>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-md-12 col-xl-12 col-12 text-right">
                            ...
                            <input type="hidden" name="id_usuario" id="id_usuario" value="<?php echo $array_usuario[0]['id_usuario']; ?>">
