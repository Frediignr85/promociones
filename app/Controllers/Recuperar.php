...
class Recuperar extends BaseController
{
    ...
    function enviar(){
        ...
        if(count($query->getResultArray()) > 0){
            ...
            $headers = "From: fredy.benitez@salud.gob.sv". "\r\n";
            $headers .= "CC:  fredy.benitez@salud.gob.sv";
                                            ...
                                            <tr>
                                              <td class="wrapper">
                                                <table border="0" cellpadding="0" cellspacing="0">
                                                  <tr>
                                                    <td>
                                                        <p>Reciba un cordial saludo del <b>MINSAL</b></p>
                                                        <p>Enviamos la Recuperacion de tu cuenta de <b>usuario</b></p>
                                                        <p>En el Sistema de <b>Promociones</b></p>
                                                        <table border="0" cellpadding="0" cellspacing="0" class="btn btn-primary">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0">
                                                                    <tbody>
                                                                    <tr>
                                                                        <td> <a href="http://localhost/promociones/recuperar/recuperar_cuenta?id='.$id.'" target="_blank">Recuperar Cuenta</a> </td>
                                                                    </tr>
                                                                    </tbody>
                                                                </table>
                                                                </td>
    ...
    function recuperar_cuenta(){
        ...
        if($query == 0){
            ...
            $xdatos['id_cuenta_recuperar'] = $query;
            return view('recuperar_cuenta',$xdatos);
        }
    }
    function cambiar(){
